...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Registriraj se");
...
private JFrame frame;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String lozinka = txtmail.getText();
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/linda","root","");   
            String sql =("SELECT * FROM reg WHERE Mail=? AND Lozinka=? ");
            ...
            ResultSet rs = insert.executeQuery();
                    if(rs.next()){
                    JOptionPane.showMessageDialog(rootPane, "Uspješno logiran");
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Krivo uneseni podatci");
                   txtmail.setText("");
                   txtpass.setText("");
        ...
        if(Mail.equals("Tomislav") && Pass.equals("123"))
        {
            Java_MysqlConn m = new Java_MysqlConn();
            this.hide();
            m.setVisible(true);
        ...
        {
        JOptionPane.showMessageDialog(this, "E-mail ili Passvord nisu dobo upisani");
        txtusername.setText("");
        txtpass.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(frame, "Potvrdi svoj izlazak","Login",
